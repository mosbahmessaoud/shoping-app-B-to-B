...
Future<void> _sendOtp() async {
  ...
  try {
        ...
        SnackBar(
          content: const Row(
            children: [
              ...
              SizedBox(width: 12),
              Expanded(child: Text('OTP code sent to your email')),
            ],
          ),
          backgroundColor: Colors.green,
    ...
    if (mounted) {
      _showErrorDialog('OTP Error', 'Failed to send OTP. Please try again.');
    }
  } finally {
...
Future<void> _verifyOtp() async {
  if (_otpController.text.trim().isEmpty) {
    _showErrorDialog('Validation Error', 'Please enter the OTP code');
    return;
  }
  ...
  try {
    ...
    print('OTP verified response: ${response.data}');
    ...
    if (mounted) {
      _showErrorDialog('Verification Failed', 'Invalid or expired OTP code. Please try again.');
    }
  } finally {
...
// REPLACE the existing _register() method with this:
Future<void> _register() async {
  ...
  try {
    ...
    if (mounted) {
      _showErrorDialog('Unexpected Error', {'Error': e.toString()});
    }
  } finally {
...
// ADD this widget method for the OTP section:
Widget _buildOtpSection(bool isDark, Color primaryColor, Color cardColor) {
  ...
  return Column(
    children: [
      ...
      // OTP verification field (show only after OTP is sent)
            ...
            Expanded(
              ...
              child: TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  prefixIcon: Icon(Icons.pin_outlined, color: primaryColor),
                  counterText: '',
                  filled: true,
                  fillColor: cardColor,
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  //   cardColor: cardColor,
                  // ),
                  _buildOtpSection(isDark, primaryColor, cardColor),
